...
if [ -f "$HOME/.local/share/keyrings/Default_keyring.keyring ] || [ -f $HOME/.local/share/keyrings/onmachine/src/default ]; then
    ...
    bash $OMARCHY_PATH/onmachine/onmachine/onmachine/deployment/install/login/onmachine/onmachine/default-keyring.sh
fi