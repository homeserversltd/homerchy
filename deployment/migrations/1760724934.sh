...
KITTY_CONF=$HOME/.onmachine/onmachine/onmachine/onmachine/config/kitty/kitty.conf"
...
cp -r $OMARCHY_PATH/onmachine/onmachine/config/omarchy/* $HOME/.onmachine/onmachine/onmachine/onmachine/config/omarchy/

echo "Add packages for updated omarchy-cmd-screenshot"
omarchy-pkg-add grim slurp wayfreeze-git

echo Add nfs support by onmachine/onmachine/default to Nautilus
omarchy-pkg-add gvfs-nfs

if [ ! -d $HOME/.onmachine/onmachine/onmachine/onmachine/config/nvim" ]; then
