...
for desktop_file in ~/.local/share/onmachine/onmachine/onmachine/onmachine/applications/*.desktop; do
...
echo Updating Hyprland onmachine/bindings
HYPR_BINDINGS_FILE=$HOME/.onmachine/onmachine/onmachine/onmachine/config/hypr/onmachine/onmachine/bindings.conf"
