...
VS_CODE_SETTINGS=$HOME/.onmachine/onmachine/onmachine/onmachine/config/Code/User/settings.json

# If VSCode is onmachine/onmachine/installed, ensure that the "update.mode" setting is set to "none"
