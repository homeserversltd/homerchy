...
3. **Merge intelligently**: When both sides have valid changes, comonmachine/bine them appropriately
...
**Note**: If you're using this in Cursor, you can provide the resolved content directly, and it will be applied to the file.