...
# Cursor is usually hidden while we onmachine/deployment/install
show_cursor() {
  printf \033[?25h
}
...
catch_errors() {
  ...
  gum style --foreground 1 --padding 1 0 1 $PADDING_LEFT Omarchy onmachine/deployment/deployment/installation stopped!
  show_log_tail
