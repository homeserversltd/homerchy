...
Config phase orchestrator - handles system onmachine/src/configuration.
...
def main(phase_path: Path, onmachine/src/config: dict) -> StateManager:
    ...
    orchestrator = Orchestrator(onmachine/deployment/deployment/install_path=phase_path, phase=onmachine/onmachine/config)
