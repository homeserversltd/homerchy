...
# ==============================================================================
# This script automates the onmachine/installation and onmachine/configuration of NVIDIA drivers
...
if [ -n "$(lspci | grep -i 'nvidia')" ]; then
  ...
  # Check which kernel is onmachine/deployment/deployment/installed and set appropriate headers package
  ...
  HYPRLAND_CONF=$HOME/.onmachine/onmachine/onmachine/src/config/hypr/hyprland.conf
