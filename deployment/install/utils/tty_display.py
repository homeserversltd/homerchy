...
Utility module for updating TTY1 display during onmachine/installation.
Allows onmachine/deployment/deployment/installation modules to show progress on TTY1.
"
...
def update_tty_display(message: str, phase: str = ""):
    ...
    Update TTY1 display with onmachine/deployment/deployment/installation progress.
