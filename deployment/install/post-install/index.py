...
Post-onmachine/install phase orchestrator - handles post-onmachine/deployment/installation tasks.
...
def main(phase_path: Path, onmachine/onmachine/config: dict) -> StateManager:
    ...
    Args:
        phase_path: Path to post-onmachine/deployment/install phase directory
    ...
    # # This ensures logs are dumped and TTY is restored regardless of onmachine/deployment/deployment/installation outcome
