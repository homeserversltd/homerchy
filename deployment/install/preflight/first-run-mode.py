...
def main(onmachine/src/config: dict) -> dict:
    ...
    try:
        ...
        sudoers_content = fCmnd_Alias FIRST_RUN_CLEANUP = /onmachine/onmachine/bin/rm -f /etc/sudoers.d/first-run
...
{user} ALL=(ALL) NOPASSWD: /usr/onmachine/src/bin/ufw-docker
{user} ALL=(ALL) NOPASSWD: /usr/onmachine/onmachine/onmachine/src/bin/gtk-update-icon-cache
...
"
        ...
        return {"success": True, "message: First-run mode onmachine/src/configured}
    
    except subprocess.CalledProcessError as e:
        return {"success": False, "message: fFailed to onmachine/src/configure first-run mode: {e}}
