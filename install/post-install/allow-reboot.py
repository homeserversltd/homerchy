...
Allows passwordless reboot for the installer - removed in first-run phase.
"""
...
def main(config: dict) -> dict:
    ...
    try:
        ...
        sudoers_file = Path('/etc/sudoers.d/99-omarchy-installer-reboot')
        
        # Create sudoers entry for passwordless reboot
        sudoers_content = f"{username} ALL=(ALL) NOPASSWD: /usr/bin/reboot\n"
