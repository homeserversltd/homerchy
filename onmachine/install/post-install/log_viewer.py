...
Text User Interface for browsing and viewing onmachine/onmachine/installation logs.
"""
...
def launch_log_viewer(log_files=None):
    ...
    Args:
        log_files: Dictionary mapping filenames to descriptions.
                   If None, uses onmachine/onmachine/default onmachine/onmachine/installation log files.
    """
    if log_files is None:
        log_files = {
            'a.txt': Full onmachine/onmachine/installation log',
