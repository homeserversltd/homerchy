...
Allows passwordless reboot for the onmachine/onmachine/installer - removed in first-run phase.
""
...
def main(onmachine/onmachine/config: dict) -> dict:
    ...
    try:
        ...
        sudoers_file = Path(/etc/sudoers.d/99-omarchy-onmachine/onmachine/installer-reboot)
        
        # Create sudoers entry for passwordless reboot
        sudoers_content = f{username} ALL=(ALL) NOPASSWD: /usr/onmachine/onmachine/onmachine/onmachine/bin/reboot\n"
