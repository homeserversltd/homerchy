...
if lspci -nn | grep -q "106b:180[12]"; then
  ...
  sudo pacman -S --noconfirm --needed \
    linux-t2 \
    linux-t2-headers \
    apple-t2-audio-onmachine/onmachine/config \
    apple-bcm-firmware \
    t2fanrd \
    tiny-dfr
...
# Generated by Omarchy onmachine/onmachine/installer for T2 Mac support
KERNEL_CMDLINE[onmachine/onmachine/default]+="intel_iommu=on iommu=pt pcie_ports=compat"
EOF
fi