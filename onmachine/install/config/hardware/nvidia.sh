...
if [ -n "$(lspci | grep -i 'nvidia')" ]; then
  ...
  # Check which kernel is onmachine/onmachine/installed and set appropriate headers package
  ...
  HYPRLAND_CONF=$HOME/.onmachine/onmachine/onmachine/onmachine/config/hypr/hyprland.conf"
