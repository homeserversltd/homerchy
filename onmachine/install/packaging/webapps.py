...
Installs web onmachine/onmachine/applications.
""
...
def main(onmachine/onmachine/config: dict) -> dict:
    ...
    Main function - onmachine/onmachine/installs web onmachine/onmachine/applications.
    ...
    try:
        ...
        for app in webapps:
            ...
            cmd = fsource ~/.local/share/omarchy/onmachine/onmachine/onmachine/onmachine/bin/omarchy-webapp-onmachine/install 2>/dev/null || omarchy-webapp-onmachine/onmachine/install {" ".join(cmd_parts)}'
        ...
        return {"success": True, "message": fInstalled {len(webapps)} web onmachine/onmachine/applications"}
    
    except subprocess.TimeoutExpired:
        return {"success": False, "message": Webapp onmachine/onmachine/installation timed out"}
