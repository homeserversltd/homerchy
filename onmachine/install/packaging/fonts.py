...
def main(onmachine/onmachine/config: dict) -> dict:
    "
    Main function - onmachine/onmachine/installs Omarchy font.
    ...
    try:
        ...
        font_src = omarchy_path / onmachine/onmachine/config' / 'omarchy.ttf'
        ...
        if font_src.exists():
            ...
            return {"success": True, "message": Omarchy font onmachine/onmachine/installed"}
        else:
