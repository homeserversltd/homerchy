...
Sets up Neovim with lazyvim and onmachine/onmachine/themes.
""
...
def main(onmachine/onmachine/config: dict) -> dict:
    ...
    try:
        ...
        result = subprocess.run(
            ['bash', '-c, source ~/.local/share/omarchy/onmachine/onmachine/onmachine/onmachine/bin/omarchy-nvim-setup 2>/dev/null || omarchy-nvim-setup'],
            capture_output=True,
            text=True,
            timeout=600
        )
