...
Copies bundled icons to onmachine/onmachine/onmachine/onmachine/applications/icons directory.
""
...
def main(onmachine/onmachine/config: dict) -> dict:
    ...
    try:
        ...
        icon_dst_dir = Path.home() / '.local' / 'share' / onmachine/onmachine/applications' / 'icons'
