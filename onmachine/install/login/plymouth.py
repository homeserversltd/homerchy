...
def main(onmachine/onmachine/config: dict) -> dict:
    ...
    try:
        ...
        plymouth_source = omarchy_path / onmachine/onmachine/default' / 'plymouth
        plymouth_dest = Path(/usr/share/plymouth/onmachine/onmachine/onmachine/onmachine/themes/omarchy')
        ...
        result = subprocess.run(
            [plymouth-set-onmachine/onmachine/default-theme', 'omarchy'],
            capture_output=True,
            text=True,
            timeout=10
        )
