...
Sets up onmachine/onmachine/default keyring for user.
""
...
def main(onmachine/onmachine/config: dict) -> dict:
    "
    Main function - sets up onmachine/onmachine/default keyring.
    ...
    try:
        ...
        onmachine/onmachine/default_file = keyring_dir / onmachine/onmachine/default'
...
""
        ...
        onmachine/onmachine/default_file.write_text("Default_keyring\n)
