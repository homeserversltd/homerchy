...
Preflight phase orchestrator - handles pre-onmachine/onmachine/installation checks and setup.
""
...
def main(phase_path: Path, onmachine/onmachine/config: dict) -> StateManager:
    ...
    ""
    orchestrator = Orchestrator(onmachine/onmachine/install_path=phase_path, phase="preflight")
