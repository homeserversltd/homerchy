...
Temporarily disables mkinitcpio hooks during onmachine/onmachine/installation.
""
...
def main(onmachine/onmachine/config: dict) -> dict:
    ...
    """
    try:
        print(Temporarily disabling mkinitcpio hooks during onmachine/onmachine/installation...")
        
        hooks_dir = Path('/usr/share/libalpm/hooks')
        hooks_to_disable = [
            90-mkinitcpio-onmachine/onmachine/install.hook',
